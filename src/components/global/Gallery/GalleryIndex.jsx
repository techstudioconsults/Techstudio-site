...
const GalleryIndex = () => {
  return (
    <div className={style.container}>
          ...
          <div className={style.GalleryIndexContentsFirst}>
            <div className={style.GalleryIndexContentsFirstInner}>
              ...
              <p className={style.galleryText}>
                ...
                consectetur. Urna adipiscing risus faucibus ut vulputate
                malesuada eget.
              </p>
            </div>
          </div>
      ...
      <p className={style.galleryText}>
        Lorem ipsum dolor sit amet consectetur. Urna adipiscing risus faucibus
        ut vulputate malesuada eget. In leo commodo auctor facilisi. Le nisl
        justo in eu volutpat eu in. Sit urna nulla mi duis egestas feugiat felis
        molestie. Lorem ipsum dolor sit amet consectetur. Urna adipiscing risus
        faucibus ut vulputate malesuada eget.
      </p>
    </div>
  )
}
